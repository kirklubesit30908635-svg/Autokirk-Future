-- Fix: align ledger.events insert shape with actual table schema
-- Removes legacy "payload" column usage and maps structured fields
...
begin
    ...
    -- ✅ FIXED: aligned with actual ledger.events schema (NO payload)
